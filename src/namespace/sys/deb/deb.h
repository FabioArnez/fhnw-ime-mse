...
//------------------------------------------ debug
  ...
  void out(unsigned val,unsigned w=0);  
  void out(int val,unsigned w=0); 
  void newln();
  ...
  void hex(unsigned short val,unsigned w=0);
  void hex(unsigned char ch,unsigned w=0);
  void hex(unsigned val,unsigned w=0);
